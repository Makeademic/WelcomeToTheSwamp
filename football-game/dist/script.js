...
function start(){
	...
	out.innerHTML = "Team Orange: " + player1.score + "<br>Team Blue: " + player2.score;
...
img.src = 'http://emilyfbrooks.com/images/FootballField2.png';
  c.drawImage(img,0,0);
  ...
  c.strokeRect(25,25,canvas.width-50,canvas.height-50);
	c.strokeStyle = "white";
	c.beginPath();
